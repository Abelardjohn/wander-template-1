...
<body>
    ...
    <section id="hal-4" class="hal-4 w-100 h-100 mx-auto text-center d-flex justify-content-center align-item-center text-white">
        ...
        <main>
            ...
            <!-- fitur premium LIVE STREAMING -->
            <div class="card-live-streaming d-flex justify-content-center align-item-center mt-4" data-aos="fade-up" data-aos-duration="2000">
                <div class="card card-lg  mt-2 rounded-3" style="width: 21rem; height:12rem">
                    <div class="card-body">
                        <p style="font-family: Poppins; font-size:1.0625rem; font-weight:500; color:#53312D; line-height: 150%; letter-spacing: 0.0425rem;" class="card-title text-center mt-2">LIVE STREAMING</p>

                        <p style="font-family: Poppins; font-size:0.875rem; font-weight:500; color:#8D6560; line-height: 150%; letter-spacing: 0.035rem;" class="card-text text-center ">We also want to share with you our happy day, through the live streaming</p>

                        <!-- button -->
                        <div class="button">
                            <a href="https://www.youtube.com/watch?v=fbd6lsLV_3k&ab_channel=JacobPetersen" target="_blank" class="btn text-white mt-2" style="padding: 0.5rem 1rem;
                                justify-content: center;
                                align-items: center;
                                gap: 0.5rem; border-radius: 0.5rem;
                                background: var(--primary-p-300, #764640);
                                font-family: Poppins;
                                font-size: 0.75rem;
                                font-style: normal;
                                font-weight: 400;
                                line-height: 150%;
                                letter-spacing: 0.03rem;"><i class="fa-solid fa-play me-1"></i> Join Live Streaming</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- section versi premium (GIFT SECTION)-->

    <section style="background-color: #c9af95 !important; margin-top: -5px; margin-bottom: -5px;" class="gift w-100 h-100 mx-auto text-center d-flex justify-content-center align-item-center">

        <div class="text text-center" data-aos="fade-down" data-aos-duration="2000">
            <h3>Wedding Gift</h3>
            <p class="text-center">Your presence is the most cherished gift for us. If you wish to give a gift, we welcome cashless. Your generosity is deeply appreciated</p>
        </div>

        <!-- card gift 1 -->
        <div class="card-live-streaming d-flex justify-content-center align-item-center mt-4" data-aos="fade-right" data-aos-duration="1500">
            <div class="card card-lg  mt-2 rounded-3" style="width: 21rem; height:13rem">
                <div class="card-body">
                    <p style="color:#764640;font-size:30px " class="card-title text-center"><i class="fa-regular fa-credit-card"></i></p>

                    <p style="font-family: Poppins; font-size: 1.1875rem;
                    font-style: normal;
                    font-weight: 500;
                    line-height: 150%;
                    color:#53312D;
                    letter-spacing: 0.0475rem;" class="card-text text-center ">BCA - Mentari Gravita</p>
                    <p style="font-family: Poppins; font-size: 1rem;
                    font-style: normal;
                    font-weight: 500;
                    line-height: 150%;
                    color:#53312D;
                    letter-spacing: 0.0475rem;" class="card-text text-center " id="copy-text2">0530-123-321</p>

                    <!-- button -->
                    <button class="btn" id="copy-btn2" style="
                    color:#53312D;
                    border-color:#53312D; font-family: Poppins;
                    font-size: 0.75rem;
                    font-style: normal;
                    font-weight: 500;
                    line-height: 150%;
                    letter-spacing: 0.03rem;">Copy Number</button>
                </div>
            </div>
        </div>
        ...
        <div class="card-live-streaming d-flex justify-content-center align-item-center mt-4" data-aos="fade-left" data-aos-duration="2000">
            <div class="card card-lg  mt-2 rounded-3" style="width: 21rem; height:13rem">
                <div class="card-body">
                    <p style="color:#764640;font-size:30px " class="card-title text-center"><i class="fa-regular fa-credit-card"></i></p>
                    ...
                    line-height: 150%;
                    color:#53312D;
                    letter-spacing: 0.0475rem;" class="card-text text-center ">MANDIRI - Bintang Angkasa</p>
                    <p style="font-family: Poppins; font-size: 1rem;
                    font-style: normal;
                    font-weight: 500;
                    line-height: 150%;
                    color:#53312D;
                    letter-spacing: 0.0475rem;" class="card-text text-center " id="copy-text">1500-4321-1234</p>

                    <!-- button -->
                    <button class="btn" id="copy-btn" style=" color:#53312D;
                    border-color:#53312D; font-family: Poppins;
                    font-size: 0.75rem;
                    font-style: normal;
                    font-weight: 500;
        ...
        <div class="text text-center mt-5" data-aos="fade-up" data-aos-duration="1500">
            <h3 style="font-size: 1.25rem;">Thankyou for the gift</h3>
            <p class="text-center" style="font-size: 0.75; ">Please let us know through confirm via<br>whatsapp</p>
            <!-- button -->
            <div class="button">
                <a href="https://wa.link/01ssu3" target="_blank" class="btn text-white mt-2" style="padding: 0.5rem 1rem;
                                justify-content: center;
                                align-items: center;
                                gap: 0.5rem; border-radius: 0.5rem;
                                background: var(--primary-p-300, #764640);
                                ...
                                font-weight: 300;
                                line-height: 150%;
                                letter-spacing: 0.03rem;"><i class="fa-regular fa-comment-dots me-2"></i>Confirm via Whatsapp</a>
            </div>
        </div>
    ...
    <!-- script untuk fitur copy text -->
    <script>
        // script.js
        const tombolSalin = document.getElementById('copy-btn');
        const teksYangAkanDisalin = document.getElementById('copy-text');

        tombolSalin.addEventListener('click', () => {
            // Salin teks dari elemen paragraf ke clipboard
            const teks = teksYangAkanDisalin.innerText;
    ...
    <!-- script untuk fitur copy text 2 -->
    <script>
        // script.js
        const tombolSalin2 = document.getElementById('copy-btn2');
        const teksYangAkanDisalin2 = document.getElementById('copy-text2');

        tombolSalin2.addEventListener('click', () => {
            // Salin teks dari elemen paragraf ke clipboard
            const teks = teksYangAkanDisalin2.innerText;
            navigator.clipboard.writeText(teks)
                .then(() => {
                    alert('Teks berhasil disalin ke clipboard!');
                })
